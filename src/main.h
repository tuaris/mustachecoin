...
static const int64 MAX_MONEY = 1000000000 * COIN; // mustachecoin: maximum of 100B coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 100 * COIN * 86400 / 250; // mustachecoin: 1440 blocks found a day. Priority cutoff is 100 mustachecoin day / 250 bytes.
    }
